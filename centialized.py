...
class CelebADataset(torch.utils.data.Dataset):
    """
    ### CelebADataset HQ dataset
    """

    def __init__(self, image_size: int):
        super().__init__()

        # CelebADataset images folder
...
@option(Configs.dataset, 'CelebADataset')
def celeb_dataset(c: Configs):
    """
    Create CelebADataset dataset
    """
...
class SVHNDataset(torchvision.datasets.SVHN):
    ...
    def __init__(self, image_size, split="train"):
        ...
        super().__init__(str(lab.get_data_path()), split=split, download=True, transform=transform)
